      ...
      <div className="flex flex-col p-3 lg:px-20 xl:px-32 text-center ">
        ...
        <div className="flex xl:flex-row flex-col justify-between">
          ...
          <motion.div
            ...
            className="w-[90%] md:w-[70%] xl:w-[45%] h-[600px] p-2.5 rounded-lg mt-12 z-10 shadow-[0_0_20px_1px_#9f9f9f] self-end"
          >
            ...
            <Slider {...settings}>
              {slideAmazon.map((image, index) => (
                <img
                  key={index}
                  src={image}
                  className="rounded-md w-full max-h-[260px]"
                  alt=""
                />
              ))}
            </Slider>
          ...
          <motion.div
            ...
            animate={inView3 && { x: 0 }}
            transition={{ duration: 1.25 }}
            className="w-[90%] md:w-[70%] xl:w-[45%] h-[600px] p-2.5 rounded-lg mt-12 z-10 shadow-[0_0_20px_1px_#9f9f9f] self-start"
          >
            <h3 className="text-3xl mb-5 font-montserrat font-semibold">
              Instapets
            </h3>{" "}
            ...
            <p className="m-5 font-roboto font-medium">
              Instapets is a project from The Odin project curriculum, the goal
              is to build a full-stack application similar to Instagram but for
              pets, where the user can create an account for the pets, post
              pictures etc.
            </p>
            <p className="flex gap-1 2xs:gap-2 justify-center items-center font-bold text-2xl">
              <span className="text-sm 2xs:text-base 2xs:font-montserrat sm:text-lg">
